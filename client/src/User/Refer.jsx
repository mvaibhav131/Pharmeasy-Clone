      ...
      <Box w={"92%"} m="6rem auto auto auto" display={"flex"}>
        ...
        <Box w={"70%"} h="auto" boxShadow="lg" p="6" rounded="md" bg="white">
          ...
          <Image
            ...
            m="auto"
            mb={"3rem"}
            src="https://assets.pharmeasy.in/web-assets/dist/651d1013.jpg"
          />
          <Text fontWeight={"bold"} fontSize="2xl" m="1rem 2rem 1rem 12rem">
            REFER FRIENDS & SAVE TOGETHER
          </Text>
          <Text fontSize={"2xl"} m="0rem 2rem 0rem 2rem" color={"gray"}>
